...
- 2026-09-04 の `/speckit.clarify` セッション（5問）で FR-002a / FR-008a / FR-008b / FR-009a / FR-009b / FR-025a を追加。いずれも上記のFR対応範囲と同じユーザーストーリーに属する。再評価の結果、16項目の状態は変化せず全項目パスを維持。追加でスコープ外に確定した項目はフォーカストラップとタッチ環境での縦スクロール競合の2件。
